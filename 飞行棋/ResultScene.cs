...
namespace 飞行棋
{
    class ResultSceneData
    {
        ...
        public int namePosX => Math.Max(0, (Game.Console_Width - title.Length) / 2);
        ...
        {
            return Math.Max(0, (Game.Console_Width - name.Length) / 2);
        }
    ...
    {
        private ResultSceneData data = new ResultSceneData();
